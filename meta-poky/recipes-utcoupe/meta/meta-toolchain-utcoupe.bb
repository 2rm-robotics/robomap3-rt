...
TOOLCHAIN_HOST_TASK_rpi-hds = "nativesdk-packagegroup-${QTNAME}-toolchain-host packagegroup-cross-canadian-${MACHINE} nativesdk-cmake nativesdk-pkgconfig nativesdk-doxygen nativesdk-packagegroup-ros-toolchain-host nativesdk-packagegroup-utcoupe-toolchain-host"

TOOLCHAIN_TARGET_TASK_BASE = "packagegroup-${QTNAME}-toolchain-target packagegroup-core-standalone-sdk-target packagegroup-ros-toolchain-target packagegroup-utcoupe-toolchain-target"
...
require recipes-hds/meta/meta-toolchain.bb
...
FILESPATH="${THISDIR}/../../recipes-hds/meta/files"
